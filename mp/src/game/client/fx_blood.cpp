...
ParticleForBlood_t	bloodCallbacks[] =
{
	...
	{ BLOOD_COLOR_ZOMBIE,			"smod_drip_g" },			// FIXME: Move to Base HL2
	{ BLOOD_COLOR_ANTLION_WORKER,	"smod_drip_y" },
#endif // HL2_EPISODIC
};
...
void BloodImpactCallback( const CEffectData & data )
{
	...
	{
		//make our low violence blood
		QAngle	vecAngles;
		VectorAngles(-data.m_vNormal, vecAngles);
		DispatchParticleEffect("ponedm_sparkles", data.m_vOrigin, vecAngles);
		return;
	}
