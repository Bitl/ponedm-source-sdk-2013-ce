...
class CAdvModelPanel : public CBaseModelPanel
{
	DECLARE_CLASS_SIMPLE(CAdvModelPanel, CBaseModelPanel);
public:
	CAdvModelPanel( vgui::Panel *parent, const char *name );
	virtual ~CAdvModelPanel();
	...
	CStudioHdr* GetModelPtr() { return m_pStudioHdr; }
